...
import { AiFillAlert, AiFillEye, AiFillEyeInvisible, AiFillLock, AiFillMail } from "react-icons/ai"
import { z } from "zod"
...
export default function SignInForm(){
    ...
    return (
        <Card className="w-full max-w-md border border-default-200 bg=default-50 shadow-xl">
            <CardHeader className="flex flex-col gap-1 items-center pg-2">
            ...
            <CardBody className="py-6">
                {authError && (
                    <div className="bg-danger-50 text-danger-700 p-4 rounded-lg mb-6 flex items-center gap-2">
                        <AiFillAlert className="h-5 w-5 flex-shrink-0" />
                        <p>{authError}</p>
                    </div>
                )}
