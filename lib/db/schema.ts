...
export const files = pgTable("files", {
    ...
    parentId: uuid("parent_id"), // tree-style hierarchy: document/projects/resume --> project is parent of resume. document is parent of projects. null is parent of document
